        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <span className={`inline-block px-3 py-1 rounded-md text-sm font-medium ${requestTypeConfig[request.requestType].color}`}>
              </span>
            </div>
            ...
            <div>
              ...
              <span className={`inline-block px-3 py-1 rounded-md text-sm font-medium ${statusConfig[request.status].color}`}>
                {statusConfig[request.status].label}
              </span>
            </div>
            
            <div>
              <label className="block text-sm font-medium text-gray-500 mb-1">ผู้รับผิดชอบ</label>
              <p className="text-gray-900">{request.assignedTo || 'ยังไม่ได้มอบหมาย'}</p>
            </div>
